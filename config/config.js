...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\vcoin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/vcoin/';
  if (isLinux) dataDir = process.env.HOME + '/.vcoin/';
}
...
var bitcoindConf = {
  ...
  user: process.env.BITCOIND_USER || 'testaki',
  pass: process.env.BITCOIND_PASS || 'test1320',
